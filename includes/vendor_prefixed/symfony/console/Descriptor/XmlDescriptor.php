 ...
 * @internal
 */
class XmlDescriptor extends \WPStack_Connect_Vendor\Symfony\Component\Console\Descriptor\Descriptor
{
    public function getInputDefinitionDocument(\WPStack_Connect_Vendor\Symfony\Component\Console\Input\InputDefinition $definition) : \DOMDocument
    {
    ...
    public function getCommandDocument(\WPStack_Connect_Vendor\Symfony\Component\Console\Command\Command $command) : \DOMDocument
    {
        $dom = new \DOMDocument('1.0', 'UTF-8');
    ...
    public function getApplicationDocument(\WPStack_Connect_Vendor\Symfony\Component\Console\Application $application, string $namespace = null) : \DOMDocument
    {
        $dom = new \DOMDocument('1.0', 'UTF-8');
        ...
        $description = new \WPStack_Connect_Vendor\Symfony\Component\Console\Descriptor\ApplicationDescription($application, $namespace, \true);
        if ($namespace) {
    ...
    private function getInputArgumentDocument(\WPStack_Connect_Vendor\Symfony\Component\Console\Input\InputArgument $argument) : \DOMDocument
    {
        $dom = new \DOMDocument('1.0', 'UTF-8');
    ...
    private function getInputOptionDocument(\WPStack_Connect_Vendor\Symfony\Component\Console\Input\InputOption $option) : \DOMDocument
    {
        $dom = new \DOMDocument('1.0', 'UTF-8');
