...
class SessionHandler implements \SessionHandlerInterface
{
     ...
     */
    public static function fromClient(\WPStack_Connect_Vendor\Aws\DynamoDb\DynamoDbClient $client, array $config = [])
    {
        $config += ['locking' => \false];
        if ($config['locking']) {
            $connection = new \WPStack_Connect_Vendor\Aws\DynamoDb\LockingSessionConnection($client, $config);
        } else {
            $connection = new \WPStack_Connect_Vendor\Aws\DynamoDb\StandardSessionConnection($client, $config);
        }
     ...
     */
    public function __construct(\WPStack_Connect_Vendor\Aws\DynamoDb\SessionConnectionInterface $connection)
    {
