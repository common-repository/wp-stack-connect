...
class RequestCompressionMiddleware
{
    ...
    private function compressRequestBody(\WPStack_Connect_Vendor\Psr\Http\Message\RequestInterface $request)
    {
        ...
        return $request->withBody(\WPStack_Connect_Vendor\GuzzleHttp\Psr7\Utils::streamFor($compressedBody))->withHeader('content-encoding', $this->encoding);
    }
