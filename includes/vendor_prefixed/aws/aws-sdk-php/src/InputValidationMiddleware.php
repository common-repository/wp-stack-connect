...
class InputValidationMiddleware
{
     ...
     * @return callable     */
    public static function wrap(\WPStack_Connect_Vendor\Aws\Api\Service $service, $mandatoryAttributeList)
    {
    ...
    public function __construct(callable $nextHandler, \WPStack_Connect_Vendor\Aws\Api\Service $service, $mandatoryAttributeList)
    {
        $this->service = $service;
        $this->nextHandler = $nextHandler;
        $this->mandatoryAttributeList = $mandatoryAttributeList;
    }
    public function __invoke(\WPStack_Connect_Vendor\Aws\CommandInterface $cmd)
    {
