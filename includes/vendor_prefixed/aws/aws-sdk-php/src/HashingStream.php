 ...
 */
class HashingStream implements \WPStack_Connect_Vendor\Psr\Http\Message\StreamInterface
{
     ...
     */
    public function __construct(\WPStack_Connect_Vendor\Psr\Http\Message\StreamInterface $stream, \WPStack_Connect_Vendor\Aws\HashInterface $hash, callable $onComplete = null)
    {
        $this->stream = $stream;
        $this->hash = $hash;
