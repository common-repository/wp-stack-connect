...
use WPStack_Connect_Vendor\Aws\Crypto\DecryptionTrait;
use WPStack_Connect_Vendor\Aws\HashingStream;
use WPStack_Connect_Vendor\Aws\PhpHash;
use WPStack_Connect_Vendor\Aws\Crypto\AbstractCryptoClient;
use WPStack_Connect_Vendor\Aws\Crypto\EncryptionTrait;
 ...
 * @deprecated
 */
class S3EncryptionClient extends \WPStack_Connect_Vendor\Aws\Crypto\AbstractCryptoClient
{
    ...
    public function putObjectAsync(array $args)
    {
        ...
        return \WPStack_Connect_Vendor\GuzzleHttp\Promise\Create::promiseFor($this->encrypt(\WPStack_Connect_Vendor\GuzzleHttp\Psr7\Utils::streamFor($args['Body']), $args['@CipherOptions'] ?: [], $provider, $envelope))->then(function ($encryptedBodyStream) use($args) {
