 ...
 */
class InstructionFileMetadataStrategy implements \WPStack_Connect_Vendor\Aws\Crypto\MetadataStrategyInterface
{
     ...
     *                            object keys.
     */
    public function __construct(\WPStack_Connect_Vendor\Aws\S3\S3Client $client, $suffix = null)
    {
