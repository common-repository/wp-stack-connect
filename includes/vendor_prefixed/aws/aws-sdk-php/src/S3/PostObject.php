...
class PostObject
{
     ...
     *                                      behalf.
     */
    public function __construct(\WPStack_Connect_Vendor\Aws\S3\S3ClientInterface $client, $bucket, array $formInputs, $jsonPolicy)
    {
        $this->client = $client;
        $this->bucket = $bucket;
    ...
    protected function getPolicyAndSignature(\WPStack_Connect_Vendor\Aws\Credentials\CredentialsInterface $creds)
    {
