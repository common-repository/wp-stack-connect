...
namespace WPStack_Connect_Vendor\Aws\S3\Exception;
...
class S3MultipartUploadException extends \WPStack_Connect_Vendor\Aws\Exception\MultipartUploadException
{
     ...
     */
    private function collectPathInfo(\WPStack_Connect_Vendor\Aws\CommandInterface $cmd)
    {
