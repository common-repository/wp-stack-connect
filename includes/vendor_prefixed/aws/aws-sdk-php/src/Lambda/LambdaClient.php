...
namespace WPStack_Connect_Vendor\Aws\Lambda;
 ...
 */
class LambdaClient extends \WPStack_Connect_Vendor\Aws\AwsClient
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return \WPStack_Connect_Vendor\Aws\Middleware::mapCommand(function (\WPStack_Connect_Vendor\Aws\CommandInterface $cmd) {
