...
class QuotaManager
{
    ...
    {
        if ($result instanceof \WPStack_Connect_Vendor\Aws\Exception\AwsException && $result->isConnectionError()) {
    ...
    public function releaseToQuota($result)
    {
        ...
        } elseif ($result instanceof \WPStack_Connect_Vendor\Aws\ResultInterface) {
