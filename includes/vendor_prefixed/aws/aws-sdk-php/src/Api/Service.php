 ...
 */
class Service extends \WPStack_Connect_Vendor\Aws\Api\AbstractModel
{
    /** @var callable */
    private $apiProvider;
    /** @var string */
    ...
    public function __construct(array $definition, callable $provider)
    {
        ...
        parent::__construct($definition, new \WPStack_Connect_Vendor\Aws\Api\ShapeMap($definition['shapes']));
     ...
     */
    public static function createSerializer(\WPStack_Connect_Vendor\Aws\Api\Service $api, $endpoint)
    {
        static $mapping = ['json' => \WPStack_Connect_Vendor\Aws\Api\Serializer\JsonRpcSerializer::class, 'query' => \WPStack_Connect_Vendor\Aws\Api\Serializer\QuerySerializer::class, 'rest-json' => \WPStack_Connect_Vendor\Aws\Api\Serializer\RestJsonSerializer::class, 'rest-xml' => \WPStack_Connect_Vendor\Aws\Api\Serializer\RestXmlSerializer::class];
        $proto = $api->getProtocol();
        if (isset($mapping[$proto])) {
            return new $mapping[$proto]($api, $endpoint);
        }
        if ($proto == 'ec2') {
            return new \WPStack_Connect_Vendor\Aws\Api\Serializer\QuerySerializer($api, $endpoint, new \WPStack_Connect_Vendor\Aws\Api\Serializer\Ec2ParamBuilder());
        }
     ...
     * @throws \UnexpectedValueException
     */
    public static function createErrorParser($protocol, \WPStack_Connect_Vendor\Aws\Api\Service $api = null)
    {
        static $mapping = ['json' => \WPStack_Connect_Vendor\Aws\Api\ErrorParser\JsonRpcErrorParser::class, 'query' => \WPStack_Connect_Vendor\Aws\Api\ErrorParser\XmlErrorParser::class, 'rest-json' => \WPStack_Connect_Vendor\Aws\Api\ErrorParser\RestJsonErrorParser::class, 'rest-xml' => \WPStack_Connect_Vendor\Aws\Api\ErrorParser\XmlErrorParser::class, 'ec2' => \WPStack_Connect_Vendor\Aws\Api\ErrorParser\XmlErrorParser::class];
     ...
     * @throws \UnexpectedValueException
     */
    public static function createParser(\WPStack_Connect_Vendor\Aws\Api\Service $api)
    {
        static $mapping = ['json' => \WPStack_Connect_Vendor\Aws\Api\Parser\JsonRpcParser::class, 'query' => \WPStack_Connect_Vendor\Aws\Api\Parser\QueryParser::class, 'rest-json' => \WPStack_Connect_Vendor\Aws\Api\Parser\RestJsonParser::class, 'rest-xml' => \WPStack_Connect_Vendor\Aws\Api\Parser\RestXmlParser::class];
        $proto = $api->getProtocol();
        if (isset($mapping[$proto])) {
            return new $mapping[$proto]($api);
        }
        if ($proto == 'ec2') {
            return new \WPStack_Connect_Vendor\Aws\Api\Parser\QueryParser($api, null, \false);
        }
        throw new \UnexpectedValueException('Unknown protocol: ' . $api->getProtocol());
    }
    /**
    ...
    public function getOperation($name)
    {
        if (!isset($this->operations[$name])) {
            ...
            $this->operations[$name] = new \WPStack_Connect_Vendor\Aws\Api\Operation($this->definition['operations'][$name], $this->shapeMap);
        } else {
    ...
    public function getErrorShapes()
    {
        ...
        foreach ($this->definition['shapes'] as $name => $definition) {
            if (!empty($definition['exception'])) {
                ...
                $result[] = new \WPStack_Connect_Vendor\Aws\Api\StructureShape($definition, $this->getShapeMap());
            }
        }
        return $result;
    }
