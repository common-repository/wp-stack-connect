...
use WPStack_Connect_Vendor\Aws\Exception\UnresolvedApiException;
/**
 * API providers.
 *
...
class ApiProvider
{
    ...
    public static function resolve(callable $provider, $type, $service, $version)
    {
        ...
        throw new \WPStack_Connect_Vendor\Aws\Exception\UnresolvedApiException($msg);
    }
    /**
    ...
    {
        return new self(__DIR__ . '/../data', \WPStack_Connect_Vendor\Aws\manifest());
    }
    /**
    ...
    public function __invoke($type, $service, $version)
    {
        ...
        try {
            return \WPStack_Connect_Vendor\Aws\load_compiled_json($path);
