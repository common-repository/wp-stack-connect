 ...
 * AWS command object.
 */
class Command implements \WPStack_Connect_Vendor\Aws\CommandInterface
{
    use HasDataTrait;
    /** @var string */
    private $name;
     ...
     */
    public function __construct($name, array $args = [], \WPStack_Connect_Vendor\Aws\HandlerList $list = null)
    {
        $this->name = $name;
        $this->data = $args;
        $this->handlerList = $list ?: new \WPStack_Connect_Vendor\Aws\HandlerList();
