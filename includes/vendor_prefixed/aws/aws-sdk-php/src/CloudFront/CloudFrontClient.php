 ...
 */
class CloudFrontClient extends \WPStack_Connect_Vendor\Aws\AwsClient
{
    /**
    ...
    public function getSignedUrl(array $options)
    {
        ...
        $urlSigner = new \WPStack_Connect_Vendor\Aws\CloudFront\UrlSigner($options['key_pair_id'], $options['private_key']);
    ...
    public function getSignedCookie(array $options)
    {
        ...
        $cookieSigner = new \WPStack_Connect_Vendor\Aws\CloudFront\CookieSigner($options['key_pair_id'], $options['private_key']);
