...
namespace WPStack_Connect_Vendor\Aws\Script\Composer;

use WPStack_Connect_Vendor\Composer\Script\Event;
use WPStack_Connect_Vendor\Symfony\Component\Filesystem\Filesystem;
class Composer
{
    public static function removeUnusedServices(\WPStack_Connect_Vendor\Composer\Script\Event $event, \WPStack_Connect_Vendor\Symfony\Component\Filesystem\Filesystem $filesystem = null)
    {
        ...
        if ($listedServices) {
            ...
            $filesystem = $filesystem ?: new \WPStack_Connect_Vendor\Symfony\Component\Filesystem\Filesystem();
