...
trait AwsClientTrait
{
    public function getPaginator($name, array $args = [])
    {
        ...
        return new \WPStack_Connect_Vendor\Aws\ResultPaginator($this, $name, $args, $config);
    }
    ...
    public function getWaiter($name, array $args = [])
    {
        ...
        return new \WPStack_Connect_Vendor\Aws\Waiter($this, $name, $args, $config);
    }
    public function execute(\WPStack_Connect_Vendor\Aws\CommandInterface $command)
    {
        return $this->executeAsync($command)->wait();
    }
    public function executeAsync(\WPStack_Connect_Vendor\Aws\CommandInterface $command)
    {
