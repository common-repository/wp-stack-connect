...
class EndpointProvider
{
    ...
    public static function resolve(callable $provider, array $args = [])
    {
        ...
        throw new \WPStack_Connect_Vendor\Aws\Exception\UnresolvedEndpointException('Unable to resolve an endpoint using the provider arguments: ' . \json_encode($args) . '. Note: you can provide an "endpoint" ' . 'option to a client constructor to bypass invoking an endpoint ' . 'provider.');
    }
    /**
    ...
    {
        return \WPStack_Connect_Vendor\Aws\Endpoint\PartitionEndpointProvider::defaultProvider();
    }
    /**
    ...
    {
        return new \WPStack_Connect_Vendor\Aws\Endpoint\PatternEndpointProvider($patterns);
    }
}
