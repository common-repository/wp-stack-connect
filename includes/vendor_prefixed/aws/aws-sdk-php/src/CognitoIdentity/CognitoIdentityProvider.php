...
namespace WPStack_Connect_Vendor\Aws\CognitoIdentity;
...
class CognitoIdentityProvider
{
    ...
    public function __construct($poolId, array $clientOptions, array $logins = [], $accountId = null)
    {
        ...
        $this->client = new \WPStack_Connect_Vendor\Aws\CognitoIdentity\CognitoIdentityClient($clientOptions + ['credentials' => \false]);
    }
    public function __invoke()
    {
        return \WPStack_Connect_Vendor\GuzzleHttp\Promise\Coroutine::of(function () {
            ...
            (yield new \WPStack_Connect_Vendor\Aws\Credentials\Credentials($result['Credentials']['AccessKeyId'], $result['Credentials']['SecretKey'], $result['Credentials']['SessionToken'], (int) $result['Credentials']['Expiration']->format('U')));
        });
    }
