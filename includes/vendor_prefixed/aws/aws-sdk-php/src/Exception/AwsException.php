 ...
 */
class AwsException extends \RuntimeException implements \WPStack_Connect_Vendor\Aws\MonitoringEventsInterface, \WPStack_Connect_Vendor\Aws\ResponseContainerInterface, \ArrayAccess
{
    use HasDataTrait;
     ...
     */
    public function __construct($message, \WPStack_Connect_Vendor\Aws\CommandInterface $command, array $context = [], \Exception $previous = null)
    {
