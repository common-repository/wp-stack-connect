...
namespace WPStack_Connect_Vendor\Aws\Ses;
 ...
 */
class SesClient extends \WPStack_Connect_Vendor\Aws\AwsClient
{
    /**
     ...
     * @return string
     */
    public static function generateSmtpPassword(\WPStack_Connect_Vendor\Aws\Credentials\CredentialsInterface $creds)
    {
        static $version = "\x02";
        static $algo = 'sha256';
     ...
     * @return string
     */
    public static function generateSmtpPasswordV4(\WPStack_Connect_Vendor\Aws\Credentials\CredentialsInterface $creds, $region)
    {
