...
class Configuration implements \WPStack_Connect_Vendor\Aws\DefaultsMode\ConfigurationInterface
{
    private $mode;
    private $retryMode;
    ...
    public function __construct($mode = 'legacy')
    {
        ...
        $data = \WPStack_Connect_Vendor\Aws\load_compiled_json(__DIR__ . '/../data/sdk-default-configuration.json');
