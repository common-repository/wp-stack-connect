 ...
 */
class EventBridgeClient extends \WPStack_Connect_Vendor\Aws\AwsClient
{
    public function __construct(array $args)
    {
        ...
        if ($this->isUseEndpointV2()) {
            ...
            $stack->appendBuild(\WPStack_Connect_Vendor\Aws\EventBridge\EventBridgeEndpointMiddleware::wrap($this->getRegion(), ['use_fips_endpoint' => $this->getConfig('use_fips_endpoint')->isUseFipsEndpoint(), 'dual_stack' => $this->getConfig('use_dual_stack_endpoint')->isUseDualStackEndpoint()], $this->getConfig('endpoint_provider'), $isCustomEndpoint), 'eventbridge.endpoint_middleware');
        }
    }
}
