 ...
 */
class AesDecryptingStream implements \WPStack_Connect_Vendor\Aws\Crypto\AesStreamInterface
{
    const BLOCK_SIZE = 16;
    // 128 bits
     ...
     */
    public function __construct(\WPStack_Connect_Vendor\Psr\Http\Message\StreamInterface $cipherText, $key, \WPStack_Connect_Vendor\Aws\Crypto\Cipher\CipherMethod $cipherMethod)
    {
