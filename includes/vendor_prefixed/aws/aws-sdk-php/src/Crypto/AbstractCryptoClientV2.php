...
abstract class AbstractCryptoClientV2
{
    ...
    public static $supportedKeyWraps = [\WPStack_Connect_Vendor\Aws\Crypto\KmsMaterialsProviderV2::WRAP_ALGORITHM_NAME];
     ...
     * @internal
     */
    public abstract function encrypt(\WPStack_Connect_Vendor\GuzzleHttp\Psr7\Stream $plaintext, array $options, \WPStack_Connect_Vendor\Aws\Crypto\MaterialsProviderV2 $provider, \WPStack_Connect_Vendor\Aws\Crypto\MetadataEnvelope $envelope);
    /**
     ...
     * @internal
     */
    public abstract function decrypt($cipherText, \WPStack_Connect_Vendor\Aws\Crypto\MaterialsProviderInterfaceV2 $provider, \WPStack_Connect_Vendor\Aws\Crypto\MetadataEnvelope $envelope, array $options = []);
}
