...
abstract class MaterialsProvider implements \WPStack_Connect_Vendor\Aws\Crypto\MaterialsProviderInterface
{
     ...
     * @internal
     */
    public abstract function fromDecryptionEnvelope(\WPStack_Connect_Vendor\Aws\Crypto\MetadataEnvelope $envelope);
    /**
