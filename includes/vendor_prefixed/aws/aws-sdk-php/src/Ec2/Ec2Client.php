...
namespace WPStack_Connect_Vendor\Aws\Ec2;
...
use WPStack_Connect_Vendor\Aws\PresignUrlMiddleware;
/**
 ...
 */
class Ec2Client extends \WPStack_Connect_Vendor\Aws\AwsClient
{
    public function __construct(array $args)
    {
        $args['with_resolved'] = function (array $args) {
            $this->getHandlerList()->appendInit(\WPStack_Connect_Vendor\Aws\PresignUrlMiddleware::wrap($this, $args['endpoint_provider'], ['operations' => ['CopySnapshot'], 'service' => 'ec2', 'presign_param' => 'PresignedUrl']), 'ec2.copy_snapshot');
        };
