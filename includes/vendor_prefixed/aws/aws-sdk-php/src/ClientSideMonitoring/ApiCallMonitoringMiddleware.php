 ...
 * @internal
 */
class ApiCallMonitoringMiddleware extends \WPStack_Connect_Vendor\Aws\ClientSideMonitoring\AbstractMonitoringMiddleware
{
    /**
    ...
    private static function getResultAttemptCount(\WPStack_Connect_Vendor\Aws\ResultInterface $result)
    {
    ...
    {
        $attemptCount = 0;
        if ($e instanceof \WPStack_Connect_Vendor\Aws\MonitoringEventsInterface) {
    ...
    {
        $data = [];
        if ($klass instanceof \WPStack_Connect_Vendor\Aws\MonitoringEventsInterface) {
    ...
    {
        if ($klass instanceof \WPStack_Connect_Vendor\Aws\Exception\AwsException && $klass->isMaxRetriesExceeded()) {
            return 1;
        }
        return 0;
    }
