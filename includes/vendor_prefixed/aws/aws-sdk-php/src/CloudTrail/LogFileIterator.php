...
use WPStack_Connect_Vendor\Aws\CloudTrail\Exception\CloudTrailException;
/**
...
class LogFileIterator extends \IteratorIterator
{
    ...
    public static function forTrail(\WPStack_Connect_Vendor\Aws\S3\S3Client $s3Client, \WPStack_Connect_Vendor\Aws\CloudTrail\CloudTrailClient $cloudTrailClient, array $options = [])
    {
        ...
        } catch (\WPStack_Connect_Vendor\Aws\CloudTrail\Exception\CloudTrailException $e) {
     ...
     * @param array    $options
     */
    public function __construct(\WPStack_Connect_Vendor\Aws\S3\S3Client $s3Client, $s3BucketName, array $options = [])
    {
