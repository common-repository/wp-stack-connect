...
use WPStack_Connect_Vendor\Aws\Api\Serializer\RestSerializer;
...
trait EndpointV2SerializerTrait
{
    ...
    private function applyScheme(&$resolvedUrl)
    {
        ...
        $scheme = $this->endpoint instanceof \WPStack_Connect_Vendor\GuzzleHttp\Psr7\Uri ? $this->endpoint->getScheme() : \parse_url($this->endpoint, \PHP_URL_SCHEME);
