...
use WPStack_Connect_Vendor\Aws\EndpointV2\Ruleset\RulesetEndpoint;
class EndpointRule extends \WPStack_Connect_Vendor\Aws\EndpointV2\Rule\AbstractRule
{
    /** @var array */
    private $endpoint;
     ...
     */
    private function resolve(array $inputParameters, \WPStack_Connect_Vendor\Aws\EndpointV2\Ruleset\RulesetStandardLibrary $standardLibrary)
    {
        ...
        return new \WPStack_Connect_Vendor\Aws\EndpointV2\Ruleset\RulesetEndpoint($uri, $properties, $headers);
    }
    /**
     ...
     * @return array
     */
    private function resolveProperties($properties, array $inputParameters, \WPStack_Connect_Vendor\Aws\EndpointV2\Ruleset\RulesetStandardLibrary $standardLibrary)
    {
     ...
     * @return array
     */
    private function resolveHeaders(array $inputParameters, \WPStack_Connect_Vendor\Aws\EndpointV2\Ruleset\RulesetStandardLibrary $standardLibrary)
    {
