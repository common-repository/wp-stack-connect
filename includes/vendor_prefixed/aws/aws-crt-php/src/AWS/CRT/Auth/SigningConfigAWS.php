...
use WPStack_Connect_Vendor\AWS\CRT\Options as Options;
class SigningConfigAWS extends \WPStack_Connect_Vendor\AWS\CRT\NativeResource
{
    public static function defaults()
    {
        return ['algorithm' => \WPStack_Connect_Vendor\AWS\CRT\Auth\SigningAlgorithm::SIGv4, 'signature_type' => \WPStack_Connect_Vendor\AWS\CRT\Auth\SignatureType::HTTP_REQUEST_HEADERS, 'credentials_provider' => null, 'region' => null, 'service' => null, 'use_double_uri_encode' => \false, 'should_normalize_uri_path' => \false, 'omit_session_token' => \false, 'signed_body_value' => null, 'signed_body_header_type' => \WPStack_Connect_Vendor\AWS\CRT\Auth\SignedBodyHeaderType::NONE, 'expiration_in_seconds' => 0, 'date' => \time(), 'should_sign_header' => null];
    }
    private $options;
    public function __construct(array $options = [])
    {
        parent::__construct();
        $this->options = $options = new \WPStack_Connect_Vendor\AWS\CRT\Options($options, self::defaults());
