 ...
 */
final class StaticCredentialsProvider extends \WPStack_Connect_Vendor\AWS\CRT\Auth\CredentialsProvider
{
    private $credentials;
    ...
    {
        parent::__construct();
        $this->credentials = new \WPStack_Connect_Vendor\AWS\CRT\Auth\AwsCredentials($options);
