...
class SigningResult extends \WPStack_Connect_Vendor\AWS\CRT\NativeResource
{
    ...
    {
        return new \WPStack_Connect_Vendor\AWS\CRT\Auth\SigningResult($ptr);
    }
    public function applyToHttpRequest(&$http_request)
    {
        ...
        $http_request = \WPStack_Connect_Vendor\AWS\CRT\HTTP\Request::unmarshall($http_request->toBlob());
    }
}
