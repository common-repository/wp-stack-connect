 ...
 */
namespace WPStack_Connect_Vendor\AWS\CRT\IO;
 ...
 */
final class EventLoopGroup extends \WPStack_Connect_Vendor\AWS\CRT\NativeResource
{
    ...
    {
        parent::__construct();
        $options = new \WPStack_Connect_Vendor\AWS\CRT\Options($options, self::defaults());
