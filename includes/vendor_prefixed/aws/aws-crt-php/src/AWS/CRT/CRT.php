...
use WPStack_Connect_Vendor\AWS\CRT\Internal\Extension;
...
final class CRT
{
    ...
    function __construct()
    {
        if (\is_null(self::$impl)) {
            try {
                self::$impl = new \WPStack_Connect_Vendor\AWS\CRT\Internal\Extension();
    ...
    {
        try {
            new \WPStack_Connect_Vendor\AWS\CRT\CRT();
            return \true;
