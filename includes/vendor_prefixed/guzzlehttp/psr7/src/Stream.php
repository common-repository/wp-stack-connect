 ...
 */
class Stream implements \WPStack_Connect_Vendor\Psr\Http\Message\StreamInterface
{
    /**
    ...
    public function getContents() : string
    {
        ...
        return \WPStack_Connect_Vendor\GuzzleHttp\Psr7\Utils::tryGetContents($this->stream);
    }
