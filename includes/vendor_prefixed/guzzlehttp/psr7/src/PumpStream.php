 ...
 */
final class PumpStream implements \WPStack_Connect_Vendor\Psr\Http\Message\StreamInterface
{
    /** @var callable|null */
    private $source;
    /** @var int|null */
    ...
    public function __construct(callable $source, array $options = [])
    {
        ...
        $this->buffer = new \WPStack_Connect_Vendor\GuzzleHttp\Psr7\BufferStream();
    }
