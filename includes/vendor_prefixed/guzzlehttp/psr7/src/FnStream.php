...
final class FnStream implements \WPStack_Connect_Vendor\Psr\Http\Message\StreamInterface
{
     ...
     * @return FnStream
     */
    public static function decorate(\WPStack_Connect_Vendor\Psr\Http\Message\StreamInterface $stream, array $methods)
    {
