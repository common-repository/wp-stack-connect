 ...
 */
final class AppendStream implements \WPStack_Connect_Vendor\Psr\Http\Message\StreamInterface
{
     ...
     */
    public function addStream(\WPStack_Connect_Vendor\Psr\Http\Message\StreamInterface $stream) : void
    {
    ...
    {
        return \WPStack_Connect_Vendor\GuzzleHttp\Psr7\Utils::copyToString($this);
    }
    /**
