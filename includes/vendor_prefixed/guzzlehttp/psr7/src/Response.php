 ...
 */
class Response implements \WPStack_Connect_Vendor\Psr\Http\Message\ResponseInterface
{
    use MessageTrait;
    ...
    public function withStatus($code, $reasonPhrase = '') : \WPStack_Connect_Vendor\Psr\Http\Message\ResponseInterface
    {
