...
final class StreamWrapper
{
     ...
     */
    public static function getResource(\WPStack_Connect_Vendor\Psr\Http\Message\StreamInterface $stream)
    {
        self::register();
     ...
     * @return resource
     */
    public static function createStreamContext(\WPStack_Connect_Vendor\Psr\Http\Message\StreamInterface $stream)
    {
