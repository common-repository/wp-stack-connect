...
use WPStack_Connect_Vendor\JmesPath\DebugRuntime;
$description = <<<EOT
...
$runtime = new \WPStack_Connect_Vendor\JmesPath\DebugRuntime(\WPStack_Connect_Vendor\JmesPath\Env::createRuntime());
