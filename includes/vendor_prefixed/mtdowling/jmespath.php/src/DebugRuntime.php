...
class DebugRuntime
{
    ...
    public function __construct(callable $runtime, $output = null)
    {
        ...
        $this->lexer = new \WPStack_Connect_Vendor\JmesPath\Lexer();
        $this->parser = new \WPStack_Connect_Vendor\JmesPath\Parser($this->lexer);
    }
    public function __invoke($expression, $data)
    {
        if ($this->runtime instanceof \WPStack_Connect_Vendor\JmesPath\CompilerRuntime) {
    ...
    {
        $lexer = new \WPStack_Connect_Vendor\JmesPath\Lexer();
    ...
    {
        $parser = new \WPStack_Connect_Vendor\JmesPath\Parser();
