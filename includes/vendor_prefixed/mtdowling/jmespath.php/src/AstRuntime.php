...
class AstRuntime
{
    ...
    public function __construct(\WPStack_Connect_Vendor\JmesPath\Parser $parser = null, callable $fnDispatcher = null)
    {
        $fnDispatcher = $fnDispatcher ?: \WPStack_Connect_Vendor\JmesPath\FnDispatcher::getInstance();
        $this->interpreter = new \WPStack_Connect_Vendor\JmesPath\TreeInterpreter($fnDispatcher);
        $this->parser = $parser ?: new \WPStack_Connect_Vendor\JmesPath\Parser();
    }
    /**
