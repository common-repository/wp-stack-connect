...
class CompilerRuntime
{
     ...
     */
    public function __construct($dir = null, \WPStack_Connect_Vendor\JmesPath\Parser $parser = null)
    {
        $this->parser = $parser ?: new \WPStack_Connect_Vendor\JmesPath\Parser();
        $this->compiler = new \WPStack_Connect_Vendor\JmesPath\TreeCompiler();
        ...
        $this->interpreter = new \WPStack_Connect_Vendor\JmesPath\TreeInterpreter();
    }
    /**
