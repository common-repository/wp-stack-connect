...
if (!\class_exists(\WPStack_Connect_Vendor\YahnisElsts\PluginUpdateChecker\v5p1\OAuthSignature::class, \false)) {
    /**
    ...
    class OAuthSignature
    {
        ...
        private function nonce()
        {
            ...
            if ($rand === null) {
                ...
                $rand = \function_exists('WPStack_Connect_Vendor\\wp_rand') ? wp_rand() : \mt_rand();
            }
