...
use stdClass;
use WP_Error;
if (!\class_exists(\WPStack_Connect_Vendor\YahnisElsts\PluginUpdateChecker\v5p1\UpdateChecker::class, \false)) {
    abstract class UpdateChecker
    {
        ...
        public function __construct($metadataUrl, $directoryName, $slug = null, $checkPeriod = 12, $optionName = '')
        {
            ...
            $this->upgraderStatus = new \WPStack_Connect_Vendor\YahnisElsts\PluginUpdateChecker\v5p1\UpgraderStatus();
            $this->updateState = new \WPStack_Connect_Vendor\YahnisElsts\PluginUpdateChecker\v5p1\StateStore($this->optionName);
            if (did_action('init')) {
                $this->loadTextDomain();
            } else {
        ...
        public function loadTextDomain()
        {
            ...
            $locale = apply_filters('plugin_locale', is_admin() && \function_exists('WPStack_Connect_Vendor\\get_user_locale') ? get_user_locale() : get_locale(), $domain);
         ...
         */
        protected function fixSupportedWordpressVersion(\WPStack_Connect_Vendor\YahnisElsts\PluginUpdateChecker\v5p1\Metadata $update = null)
        {
            ...
            if (\function_exists('WPStack_Connect_Vendor\\get_core_updates')) {
        ...
        {
            if (!\function_exists('WPStack_Connect_Vendor\\wp_get_installed_translations')) {
                return array();
            }
        ...
        {
            if (\class_exists('WPStack_Connect_Vendor\\Debug_Bar', \false) && \file_exists(\dirname(__FILE__) . '/DebugBar')) {
                $this->debugBarExtension = $this->createDebugBarExtension();
            }
        }
        protected function createDebugBarExtension()
        {
            return new \WPStack_Connect_Vendor\YahnisElsts\PluginUpdateChecker\v5p1\DebugBar\Extension($this);
        }
        /**
