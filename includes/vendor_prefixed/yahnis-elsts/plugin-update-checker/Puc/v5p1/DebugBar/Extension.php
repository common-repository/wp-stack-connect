...
use WPStack_Connect_Vendor\YahnisElsts\PluginUpdateChecker\v5p1\PucFactory;
use WPStack_Connect_Vendor\YahnisElsts\PluginUpdateChecker\v5p1\UpdateChecker;
if (!\class_exists(\WPStack_Connect_Vendor\YahnisElsts\PluginUpdateChecker\v5p1\DebugBar\Extension::class, \false)) {
    class Extension
    {
        const RESPONSE_BODY_LENGTH_LIMIT = 4000;
        /** @var UpdateChecker */
        protected $updateChecker;
        protected $panelClass = \WPStack_Connect_Vendor\YahnisElsts\PluginUpdateChecker\v5p1\DebugBar\Panel::class;
        ...
        private function getLibraryUrl($filePath)
        {
            ...
            $absolutePath = \WPStack_Connect_Vendor\YahnisElsts\PluginUpdateChecker\v5p1\PucFactory::normalizePath($absolutePath);
            $pluginDir = \WPStack_Connect_Vendor\YahnisElsts\PluginUpdateChecker\v5p1\PucFactory::normalizePath(WP_PLUGIN_DIR);
            $muPluginDir = \WPStack_Connect_Vendor\YahnisElsts\PluginUpdateChecker\v5p1\PucFactory::normalizePath(WPMU_PLUGIN_DIR);
            $themeDir = \WPStack_Connect_Vendor\YahnisElsts\PluginUpdateChecker\v5p1\PucFactory::normalizePath(get_theme_root());
