...
if (!\class_exists(\WPStack_Connect_Vendor\YahnisElsts\PluginUpdateChecker\v5p1\DebugBar\PluginExtension::class, \false)) {
    class PluginExtension extends \WPStack_Connect_Vendor\YahnisElsts\PluginUpdateChecker\v5p1\DebugBar\Extension
    {
        /** @var UpdateChecker */
        protected $updateChecker;
        public function __construct($updateChecker)
        {
            parent::__construct($updateChecker, \WPStack_Connect_Vendor\YahnisElsts\PluginUpdateChecker\v5p1\DebugBar\PluginPanel::class);
