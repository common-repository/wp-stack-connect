...
if (!\class_exists(\WPStack_Connect_Vendor\YahnisElsts\PluginUpdateChecker\v5p1\DebugBar\Panel::class, \false) && \class_exists('WPStack_Connect_Vendor\\Debug_Bar_Panel', \false)) {
    class Panel extends \WPStack_Connect_Vendor\Debug_Bar_Panel
    {
        /** @var UpdateChecker */
