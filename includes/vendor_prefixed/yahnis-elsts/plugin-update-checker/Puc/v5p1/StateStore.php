...
if (!\class_exists(\WPStack_Connect_Vendor\YahnisElsts\PluginUpdateChecker\v5p1\StateStore::class, \false)) {
    class StateStore
    {
        /**
         ...
         * @return $this
         */
        public function setUpdate(\WPStack_Connect_Vendor\YahnisElsts\PluginUpdateChecker\v5p1\Update $update = null)
        {
            $this->lazyLoad();
            $this->update = $update;
            return $this;
        ...
        public function save()
        {
            ...
            if (isset($this->update)) {
                ...
                if (\WPStack_Connect_Vendor\YahnisElsts\PluginUpdateChecker\v5p1\Utils::startsWith($updateClass, $prefix)) {
        ...
        protected function load()
        {
            ...
            $this->lastCheck = \intval(\WPStack_Connect_Vendor\YahnisElsts\PluginUpdateChecker\v5p1\Utils::get($state, 'lastCheck', 0));
            $this->checkedVersion = \WPStack_Connect_Vendor\YahnisElsts\PluginUpdateChecker\v5p1\Utils::get($state, 'checkedVersion', '');
            $this->update = null;
