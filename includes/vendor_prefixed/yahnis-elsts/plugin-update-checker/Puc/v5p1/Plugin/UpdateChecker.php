...
namespace WPStack_Connect_Vendor\YahnisElsts\PluginUpdateChecker\v5p1\Plugin;

use WPStack_Connect_Vendor\YahnisElsts\PluginUpdateChecker\v5p1\InstalledPackage;
use WPStack_Connect_Vendor\YahnisElsts\PluginUpdateChecker\v5p1\UpdateChecker as BaseUpdateChecker;
use WPStack_Connect_Vendor\YahnisElsts\PluginUpdateChecker\v5p1\Scheduler;
use WPStack_Connect_Vendor\YahnisElsts\PluginUpdateChecker\v5p1\DebugBar;
if (!\class_exists(\WPStack_Connect_Vendor\YahnisElsts\PluginUpdateChecker\v5p1\Plugin\UpdateChecker::class, \false)) {
    /**
     ...
     * @access public
     */
    class UpdateChecker extends \WPStack_Connect_Vendor\YahnisElsts\PluginUpdateChecker\v5p1\UpdateChecker
    {
        ...
        public function __construct($metadataUrl, $pluginFile, $slug = '', $checkPeriod = 12, $optionName = '', $muPluginFile = '')
        {
            ...
            $this->extraUi = new \WPStack_Connect_Vendor\YahnisElsts\PluginUpdateChecker\v5p1\Plugin\Ui($this);
        }
        /**
        ...
        {
            $scheduler = new \WPStack_Connect_Vendor\YahnisElsts\PluginUpdateChecker\v5p1\Scheduler($this, $checkPeriod, array('load-plugins.php'));
        ...
        {
            list($pluginInfo, $result) = $this->requestMetadata(\WPStack_Connect_Vendor\YahnisElsts\PluginUpdateChecker\v5p1\Plugin\PluginInfo::class, 'request_info', $queryArgs);
            if ($pluginInfo !== null) {
        ...
        public function requestUpdate()
        {
            ...
            $update = \WPStack_Connect_Vendor\YahnisElsts\PluginUpdateChecker\v5p1\Plugin\Update::fromPluginInfo($pluginInfo);
        ...
        {
            return new \WPStack_Connect_Vendor\YahnisElsts\PluginUpdateChecker\v5p1\DebugBar\PluginExtension($this);
        }
        /**
        ...
        {
            return new \WPStack_Connect_Vendor\YahnisElsts\PluginUpdateChecker\v5p1\Plugin\Package($this->pluginAbsolutePath, $this);
        }
        /**
         * @return Package
         */
