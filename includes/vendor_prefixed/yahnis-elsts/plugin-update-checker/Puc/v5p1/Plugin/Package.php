...
if (!\class_exists(\WPStack_Connect_Vendor\YahnisElsts\PluginUpdateChecker\v5p1\Plugin\Package::class, \false)) {
    class Package extends \WPStack_Connect_Vendor\YahnisElsts\PluginUpdateChecker\v5p1\InstalledPackage
    {
        /**
         * @var UpdateChecker
         */
        ...
        public function getPluginHeader()
        {
            ...
            if (!\function_exists('WPStack_Connect_Vendor\\get_plugin_data')) {
        ...
        public function isMuPlugin()
        {
            ...
            if ($cachedResult === null) {
                ...
                if ($muPluginDir === \false || $pluginPath === \false) {
                    ...
                    $pluginPath = \WPStack_Connect_Vendor\YahnisElsts\PluginUpdateChecker\v5p1\PucFactory::normalizePath($this->pluginAbsolutePath);
                }
