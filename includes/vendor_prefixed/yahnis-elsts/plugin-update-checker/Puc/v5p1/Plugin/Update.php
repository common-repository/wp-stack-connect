...
if (!\class_exists(\WPStack_Connect_Vendor\YahnisElsts\PluginUpdateChecker\v5p1\Plugin\Update::class, \false)) {
    /**
    ...
    class Update extends \WPStack_Connect_Vendor\YahnisElsts\PluginUpdateChecker\v5p1\Update
    {
        ...
        public static function fromJson($json)
        {
            ...
            $pluginInfo = \WPStack_Connect_Vendor\YahnisElsts\PluginUpdateChecker\v5p1\Plugin\PluginInfo::fromJson($json);
            if ($pluginInfo !== null) {
