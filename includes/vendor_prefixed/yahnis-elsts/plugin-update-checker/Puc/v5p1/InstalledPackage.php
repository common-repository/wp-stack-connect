...
if (!\class_exists(\WPStack_Connect_Vendor\YahnisElsts\PluginUpdateChecker\v5p1\InstalledPackage::class, \false)) {
    /**
        ...
        public function getFileHeader($content)
        {
            ...
            foreach ($headers as $field => $name) {
                ...
                if ($success === 1 && $matches[1]) {
                    $value = $matches[1];
                    if (\function_exists('WPStack_Connect_Vendor\\_cleanup_header_comment')) {
