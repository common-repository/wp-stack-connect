...
use LogicException;
use stdClass;
use WPStack_Connect_Vendor\WP_Error;
if (!\class_exists(\WPStack_Connect_Vendor\YahnisElsts\PluginUpdateChecker\v5p1\Metadata::class, \false)) {
    /**
    ...
    abstract class Metadata
    {
        ...
        protected static function createFromJson($json, $target)
        {
            ...
            if (empty($apiResponse) || !\is_object($apiResponse)) {
                ...
                do_action('puc_api_error', new \WPStack_Connect_Vendor\WP_Error('puc-invalid-json', $errorMessage));
