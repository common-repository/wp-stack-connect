...
if (!\class_exists(\WPStack_Connect_Vendor\YahnisElsts\PluginUpdateChecker\v5p1\Scheduler::class, \false)) {
    /**
    ...
    class Scheduler
    {
        ...
        public function __construct($updateChecker, $checkPeriod, $hourlyHooks = array('load-plugins.php'))
        {
            ...
            if ($this->checkPeriod > 0) {
                ...
                if (!wp_next_scheduled($this->cronHook) && !\defined('WP_INSTALLING')) {
                    ...
                    if (\function_exists('WPStack_Connect_Vendor\\wp_rand')) {
        ...
        )
        {
            ...
            if (\is_a($this->updateChecker, \WPStack_Connect_Vendor\YahnisElsts\PluginUpdateChecker\v5p1\Theme\UpdateChecker::class)) {
            ...
            if (\is_a($this->updateChecker, \WPStack_Connect_Vendor\YahnisElsts\PluginUpdateChecker\v5p1\Plugin\UpdateChecker::class)) {
