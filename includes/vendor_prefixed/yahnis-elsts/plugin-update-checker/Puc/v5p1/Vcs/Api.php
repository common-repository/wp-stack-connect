...
use WPStack_Connect_Vendor\PucReadmeParser;
if (!\class_exists(\WPStack_Connect_Vendor\YahnisElsts\PluginUpdateChecker\v5p1\Vcs\Api::class, \false)) {
    abstract class Api
    {
        ...
        public function getRemoteReadme($ref = 'master')
        {
            ...
            $parser = new \WPStack_Connect_Vendor\PucReadmeParser();
        ...
        public function getRemoteChangelog($ref, $localDirectory)
        {
            ...
            return \WPStack_Connect_Vendor\Parsedown::instance()->text($changelog);
        }
        /**
