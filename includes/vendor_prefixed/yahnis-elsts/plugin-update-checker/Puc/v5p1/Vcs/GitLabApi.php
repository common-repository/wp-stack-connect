...
if (!\class_exists(\WPStack_Connect_Vendor\YahnisElsts\PluginUpdateChecker\v5p1\Vcs\GitLabApi::class, \false)) {
    class GitLabApi extends \WPStack_Connect_Vendor\YahnisElsts\PluginUpdateChecker\v5p1\Vcs\Api
    {
        ...
        public function getLatestRelease()
        {
            ...
            foreach ($releases as $release) {
                ...
                return new \WPStack_Connect_Vendor\YahnisElsts\PluginUpdateChecker\v5p1\Vcs\Reference(array('name' => $release->tag_name, 'version' => $versionNumber, 'downloadUrl' => $downloadUrl, 'updated' => $release->released_at, 'apiResponse' => $release));
            }
            return null;
        }
        /**
        ...
        public function getLatestTag()
        {
            ...
            $tag = $versionTags[0];
            return new \WPStack_Connect_Vendor\YahnisElsts\PluginUpdateChecker\v5p1\Vcs\Reference(array('name' => $tag->name, 'version' => \ltrim($tag->name, 'v'), 'downloadUrl' => $this->buildArchiveDownloadUrl($tag->name), 'apiResponse' => $tag));
        }
        /**
        ...
        protected function api($url, $queryParams = array())
        {
            ...
            $error = new \WPStack_Connect_Vendor\WP_Error('puc-gitlab-http-error', \sprintf('GitLab API error. URL: "%s",  HTTP status code: %d.', $baseUrl, $code));
        ...
        public function enableReleasePackages()
        {
            $this->enableReleaseAssets(
                /** @lang RegExp */
                '/\\.zip($|[?&#])/i',
                \WPStack_Connect_Vendor\YahnisElsts\PluginUpdateChecker\v5p1\Vcs\Api::REQUIRE_RELEASE_ASSETS
            );
        }
