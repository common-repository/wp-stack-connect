...
use WPStack_Connect_Vendor\YahnisElsts\PluginUpdateChecker\v5p1\Plugin;
if (!\class_exists(\WPStack_Connect_Vendor\YahnisElsts\PluginUpdateChecker\v5p1\Vcs\PluginUpdateChecker::class, \false)) {
    class PluginUpdateChecker extends \WPStack_Connect_Vendor\YahnisElsts\PluginUpdateChecker\v5p1\Plugin\UpdateChecker implements \WPStack_Connect_Vendor\YahnisElsts\PluginUpdateChecker\v5p1\Vcs\BaseChecker
    {
        ...
        public function requestInfo($unusedParameter = null)
        {
            ...
            $info = new \WPStack_Connect_Vendor\YahnisElsts\PluginUpdateChecker\v5p1\Plugin\PluginInfo();
