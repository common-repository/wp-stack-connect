...
if (!\trait_exists(\WPStack_Connect_Vendor\YahnisElsts\PluginUpdateChecker\v5p1\Vcs\ReleaseAssetSupport::class, \false)) {
    trait ReleaseAssetSupport
    {
         ...
         * @var int
         */
        protected $releaseAssetPreference = \WPStack_Connect_Vendor\YahnisElsts\PluginUpdateChecker\v5p1\Vcs\Api::PREFER_RELEASE_ASSETS;
        /**
         ...
         */
        public function enableReleaseAssets($nameRegex = null, $preference = \WPStack_Connect_Vendor\YahnisElsts\PluginUpdateChecker\v5p1\Vcs\Api::PREFER_RELEASE_ASSETS)
        {
