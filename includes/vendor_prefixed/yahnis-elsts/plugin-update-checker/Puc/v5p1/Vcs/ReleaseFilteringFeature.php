...
if (!\trait_exists(\WPStack_Connect_Vendor\YahnisElsts\PluginUpdateChecker\v5p1\Vcs\ReleaseFilteringFeature::class, \false)) {
    trait ReleaseFilteringFeature
    {
         ...
         */
        protected $releaseFilterByType = \WPStack_Connect_Vendor\YahnisElsts\PluginUpdateChecker\v5p1\Vcs\Api::RELEASE_FILTER_SKIP_PRERELEASE;
        /**
         ...
         * @return $this
         */
        public function setReleaseFilter($callback, $releaseTypes = \WPStack_Connect_Vendor\YahnisElsts\PluginUpdateChecker\v5p1\Vcs\Api::RELEASE_FILTER_SKIP_PRERELEASE, $maxReleases = 20)
        {
            if ($maxReleases > 100) {
         ...
         */
        public function setReleaseVersionFilter($regex, $releaseTypes = \WPStack_Connect_Vendor\YahnisElsts\PluginUpdateChecker\v5p1\Vcs\Api::RELEASE_FILTER_SKIP_PRERELEASE, $maxReleasesToExamine = 20)
        {
        ...
        protected function shouldSkipPreReleases()
        {
            ...
            //more release types.
            return $this->releaseFilterByType !== \WPStack_Connect_Vendor\YahnisElsts\PluginUpdateChecker\v5p1\Vcs\Api::RELEASE_FILTER_ALL;
        }
        /**
         * @return bool
         */
